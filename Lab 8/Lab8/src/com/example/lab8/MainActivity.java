...
public class MainActivity extends Activity implements  ServiceHelper.EEGHandler{
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         super.onCreate(savedInstanceState);
            ...
            mHelper = new ServiceHelper(this, this, null,"20:13:01:24:01:07");//bluetooth address
            mImage = (ImageView) findViewById(R.id.image);
            mText = (TextView) findViewById(R.id.text);
            mBitMap = BitmapFactory.decodeResource(getResources(), R.drawable.funnyhampster);
